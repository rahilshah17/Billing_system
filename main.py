...
#===================Python Variables=======================
menu_category = ["Pens","Pencils","Print","Paper","Other","Seasonal"]

menu_category_dict = {"Pens":"1 Tea & Coffee.txt","Pencils":"2 Beverages.txt",
                "Print":"3 Fast Food.txt","Paper":"4 South Indian.txt",
                "Other":"5 Starters.txt","Seasonal":"6 Main Course.txt"}
